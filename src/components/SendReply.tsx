  ...
  return (
    <div className='flex flex-col w-full h-full '>
        <div>
            ...
            <div className={`text-[12px] flex pt-2 px-8 py-2 h-7   items-center gap-2`} >
        ...
        <div className='h-[54px] 0 w-full '>
            ...
            <div className='flex text-[12px] gap-1'>
                ...
                <div className='w-[100px] h-8 items-center  mb-3 rounded gap-1 flex justify-center  cursor-pointer'>
                    <Zap className='h-4' />
                    <button >Variables</button>
                </div>
                <div className='w-[120px] h-8 items-center  mb-3 rounded gap-1 flex justify-center  cursor-pointer'>
                    <Eye className='h-4'/>
